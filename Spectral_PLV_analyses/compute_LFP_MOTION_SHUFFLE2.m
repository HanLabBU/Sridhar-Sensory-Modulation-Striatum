%% Baseline vs shuffle - LFP-speed phase locking
clear all
close all
...
wavDN(:,~( deltP>thresD  & (stim_vec==0) &  (moving_period==1)))=NaN;
wavDN2(:,~(  deltP>thresD  & (stim_vec==0) &(moving_period==1)))=NaN;
wavAN(:,~( deltP>thresD  & (stim_vec==0) &  (moving_period==1)))=NaN;
