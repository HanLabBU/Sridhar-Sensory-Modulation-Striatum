...
wavD(~(moving_period==1 &stim_vec==0 ))=NaN;
wavD2(~(moving_period==1&stim_vec==1 ))=NaN;
...
% 884, >20, tstat= -0.7857, p=0.4323 %stim_freq=1
% 675, >20,  tstat: -0.9990, p=  0.3182 %stim_freq=2
...
print(gcf, '-dpdf' , '-r300' ,'-painters', [ savepath 'CA_LFP_COND_STIM_PLV' num2str(stim_freq) '.pdf'])
%  
