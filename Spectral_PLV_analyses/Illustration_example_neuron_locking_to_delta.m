...
[cwt_out,frs]=runcwt(lfp_all, [1 10],FS);
cha=1;
freq2.freq=frs;
...
plot(freq2.freq,nanmean(aCOHs(:,neuron),2),'r')
hold on
plot(freq2.freq,nanmean(aCOHs2(:,neuron),2),'k')
axis tight
print(gcf, '-dpdf' , '-r300' ,'-painters', [ savepath 'Example_neuron_Ca_LFP_across_freq_shuf2''.pdf'])
