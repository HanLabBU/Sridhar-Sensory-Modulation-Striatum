clear all
close all
%% Phase locking between LFP and speed in baseline vs stimulation
...
V2=nanmean(aCOHs2(fsel,:),1)';
 ...
 %V1=aCOHs';V2=aCOHs2';
figure('COlor','w','Position', [300 150 130 160],'Renderer', 'painters')
%figure('COlor','w','Position', [300 400 150 140],'Renderer', 'painters')
%violinplot2(V1- V2,[1.3 ],'ViolinColor', [ 0.4 0.7 0.6; 0 0 0.9])
violinplot2(V1,[1.2 ],'ViolinColor', [ 0.2 0.2 0.8; 0 0 0.9])
violinplot2( V2,[1.9 ],'ViolinColor', [ 0.8 0.2 0.2; 0 0 0.9])
line([ 0.8 2.3], [ -0.01 -0.01],'COlor', [ 1 1 1 ],'Linewidth',0.5)
%line([ 0.7 2.4], [ 0  0],'COlor', [ 0 0 0 ],'Linewidth',0.5)
axis tight;set(gca,'Xtick',[],'Xticklabel',[])
ylim([-0.01 0.12])
yticks([0,0.05,0.1])
 print(gcf, '-dpdf' , '-r300' ,'-painters', [ savepath 'LFP_PLV_motion_stim_nostim_VIOLIN' num2str(stim_freq) '.pdf'])
% 

freq=freq2.freq;
save("baseline_LFP_speed_PLV_10Hz.mat",'aCOHs','freq')